...
func Make_Pkg_Windows(ActionFlag string, DecryptKey string, DecryptIV string, UserID string, UserKey string, NodeIDTotalCnt string, NodeIDCurCnt string, EnddateYear string, EnddateMon string, EnddateDay string, NodeID []string, Basic_Path string, Home_Path string, IstFileName string, OEMName string) (string, string, error) {
	...
	pkg_mutex.Lock()
	defer pkg_mutex.Unlock()

	if ActionFlag == "Create" || ActionFlag == "Delete" || ActionFlag == "Modify" {
	} else {
...
func Make_Pkg_Linux(ActionFlag string, DecryptKey string, DecryptIV string, UserID string, UserKey string, NodeIDTotalCnt string, NodeIDCurCnt string, EnddateYear string, EnddateMon string, EnddateDay string, NodeID []string, Basic_Path string, Home_Path string, PkgFileName string, OEMName string) (string, string, error) {
	var IsNotExistFile bool
	var IsNotExistPath bool
	var err error
